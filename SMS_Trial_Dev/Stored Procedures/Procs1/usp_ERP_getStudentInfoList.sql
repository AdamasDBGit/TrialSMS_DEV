...
BEGIN
  ...
  from [SMS].[dbo].[T_ERP_Student_Detail] as SD
  join [SMS].[dbo].[T_Student_Class_Section] as SCS on SD.I_Student_Detail_ID = scs.I_Student_Detail_ID and SD.S_Student_ID= scs.S_Student_ID
  inner join [SMS].[dbo].[T_School_Group_Class]as SGC on SCS.I_School_Group_Class_ID = SGC.I_School_Group_Class_ID
  inner join [SMS].[dbo].[T_Class] as TC on TC.I_Class_ID = SGC.I_Class_ID 
  inner join [SMS].[dbo].[T_ERP_Enquiry_Regn_Guardian_Master] as ERGM on ERGM.I_Enquiry_Regn_ID =sd.R_I_Enquiry_Regn_ID
  inner join [SMS].[dbo].[T_ERP_Enquiry_Regn_Detail] as ERD on ERD.I_Enquiry_Regn_ID = SD.R_I_Enquiry_Regn_ID
