...
SET NOCOUNT ON;
	...
	set @iClassGroupID = (select SGC.I_School_Group_Class_ID as GroupClass from  [SMS].[dbo].[T_School_Group_Class] SGC where SGC.I_School_Group_ID = @iSchoolGroupID and SGC.I_Class_ID =@iClassID)
	...
	BEGIN
	update [SMS].[dbo].[T_Student_Class_Section]
	set 
...
END
	...
	BEGIN
	Insert into [SMS].[dbo].[T_Student_Class_Section] (I_Student_Detail_ID,I_School_Session_ID,I_School_Group_Class_ID,I_Section_ID,I_Stream_ID,I_Status)
