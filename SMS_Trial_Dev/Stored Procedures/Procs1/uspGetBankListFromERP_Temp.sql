CREATE PROCEDURE [ERP].[uspGetBankListFromERP_Temp]
(
	@iBrandID INT
)
AS
...
DECLARE @iBrandIDNew INT=@iBrandID
...
INSERT INTO #temp
	...
	SELECT BANK_ACCOUNT_NAME,BANK_ACCOUNT_NUM,ENTITY_NAME FROM #temp T WHERE BRAND_ID=@iBrandIDNew;
