...
BEGIN        
 ...
 -- )        
   TEERD.App_Payment_Status=1 and TEERD.I_Enquiry_Status_Code=1 and I_ERP_Entry = 1 --and (TEERD.R_I_AdmStgTypeID = @AdmissionStageID OR @AdmissionStageID IS NULL)      
    --end    
