...
-- insert value for the invoice child                   
        INSERT  INTO #tempInvoiceChild        
            ...
            -------Set Currency ------------
			Declare @CurrencyID int ,@I_Course_FeePlan_ID int
			SET @I_Course_FeePlan_ID=(Select top 1 I_Course_FeePlan_ID from #tempInvoiceChild)
			SET @CurrencyID=(select top 1 I_Currency_ID from T_Course_Fee_Plan where I_Course_Fee_Plan_ID=@I_Course_FeePlan_ID)
