...
from 
  [SMS].[dbo].[T_Student_Class_Section] as SCS 
  ...
  left join [SMS].[dbo].[T_Section] as TS on TS.I_Section_ID = SCS.I_Section_ID 
  inner join [SMS].[dbo].[T_Class] as TC on TC.I_Class_ID = SGC.I_Class_ID 
  inner join [SMS].[dbo].[T_School_Group] as TSG on TSG.I_School_Group_ID = SGC.I_School_Group_ID 
  left join [SMS].[dbo].[T_Stream] as TSt on TSt.I_Stream_ID = SCS.I_Stream_ID
